...
class BlockDrawer:
	...
	def draw_mesh(self, k, block, d_surf):
		points = block_grid_space_manager.calculate_points(k, block, self.bgss)
	...
	def draw_fill(self, k, block, d_surf):
		points = block_grid_space_manager.calculate_points(k, block, self.bgss)
		...
		pygame.draw.polygon(d_surf, DEFAULT_TOP_COLOUR, points.top_points)
