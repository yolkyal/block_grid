import unittest
from block_grid.src import block, block_grid, block_grid_selector, block_grid_space_manager
...
class TestBlockGridSelector(unittest.TestCase):
	...
	@mock.patch('block_grid.src.collision_utils.is_diamond_point_collision')
	...
	def testOrdering(self, mock_diamond_collision, mock_calculate_points):
		...
		mock.call((1, 1), grid.blocks[(1, 1)], self.bgss),
		mock.call((1, 0), grid.blocks[(1, 0)], self.bgss),
		mock.call((0, 1), grid.blocks[(0, 1)], self.bgss),
		mock.call((0, 0), grid.blocks[(0, 0)], self.bgss)
		]
